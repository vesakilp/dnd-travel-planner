...
export function generateNarrative(
  ...
  sections.push(
    "",
    "**DM prompts:**",
    `• What rumour or secret does someone let slip before the party leaves ${stage.startLocation}?`,
    `• How does the terrain between ${stage.startLocation} and ${stage.endLocation} reveal something new about one of the characters?`,
  );
